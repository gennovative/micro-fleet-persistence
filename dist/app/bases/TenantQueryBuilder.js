...
class TenantQueryBuilder {
    ...
    buildPatch(entity, prevQuery, rawQuery, opts = {}) {
        return rawQuery.patch(entity).whereComposite(this._EntityClass['idColumn'], '=', this._toArr(entity, this._EntityClass['idProp']));
    }
    ...
    buildUpdate(entity, prevQuery, rawQuery, opts = {}) {
        return rawQuery.update(entity).whereComposite(this._EntityClass['idColumn'], '=', this._toArr(entity, this._EntityClass['idProp']));
    }
    _toArr(pk, arr) {
